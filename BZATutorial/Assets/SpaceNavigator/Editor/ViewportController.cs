...
class ViewportController {
    ...
    //Added this for space pilot pro shortcuts.
    [MenuItem("Window/SpaceNavigator/Shortcut/Fly %&m", false, 999)]
    static void SetFly()
    {
    ...
    [MenuItem("Window/SpaceNavigator/Shortcut/Orbit %&o", false, 999)]
    static void SetOrbit()
    {
        Mode = OperationMode.Orbit;

    }

    [MenuItem("Window/SpaceNavigator/Shortcut/Telekinesis %&n", false, 999)]
    static void SetTele()
    {
        Mode = OperationMode.Telekinesis;

    }

    [MenuItem("Window/SpaceNavigator/Shortcut/Grab/fly %&b", false, 999)]
    static void SetGrabFly()
    {
        Mode = OperationMode.GrabMove;
